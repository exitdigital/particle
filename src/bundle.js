...
var pipe_1 = __webpack_require__(51);
/**
...
var Particle = function () {
  ...
  (0, _createClass3.default)(Particle, [{
    key: 'setVelocity',
    value: function setVelocity(speed, direction) {
    ...
    value: function setGravity(gravity) {
      this.gravity = new _vector2.default(0, gravity);
    }
  }, {
    key: 'accelerate',
...
var Observable_1 = __webpack_require__(0);
var merge_1 = __webpack_require__(8);
...
var Observable_1 = __webpack_require__(0);
var throttleTime_1 = __webpack_require__(67);
...
var _pong = __webpack_require__(88);
...
if (typeof window !== 'undefined') {
  ...
  var init = function init(_ref) {
    ...
    pong.init({ viewport: viewport });
    scroll.init({ viewport: viewport });
  ...
  window.onload = function () {
    var header = new _header2.default({ el: document.getElementById('header') }),
        begin = function begin(last, next) {
      console.log("begin scroll", last, next);
      if (next === 0) {
        header.hide();
      }
    },
        complete = function complete(last, next) {
      console.log("end scroll", last, next);
      if (next !== 0) {
        header.show();
      }
    },
        scroll = new _scroll2.default({ document: document, className: 'section', begin: begin, complete: complete }),
        pong = new _pong2.default({ document: document, id: 'pong', scroll: scroll }),
    ...
    init({ scroll: scroll, pong: pong, menu: menu, header: header });
    _Observable.Observable.fromEvent(window, 'resize').debounceTime(100).subscribe(function () {
      return init({ scroll: scroll, pong: pong, menu: menu, header: header });
    });
  };
}
...
var Scroll = (0, _autobindDecorator2.default)(_class = function () {
  function Scroll(_ref) {
    var document = _ref.document,
        className = _ref.className,
        _ref$begin = _ref.begin,
        begin = _ref$begin === undefined ? noop : _ref$begin,
  ...
  (0, _createClass3.default)(Scroll, [{
    ...
    value: function createSubscription() {
      ...
      var length = this.offsets.length - 1;
      var wrapMinMax = function wrapMinMax(v) {
        if (v < 0) {
          return 0;
        } else if (v >= length) {
          return length;
      ...
      var wheel$ = _Observable.Observable.fromEvent(this.document, wheelEvent, function (e) {
        return e;
      }, { passive: false }).map(function (e) {
        var value = e.wheelDelta || -e.deltaY || -e.detail;
        return { direction: Math.max(-1, Math.min(1, value)) * -1, e: e };
      });

      var createTouchMove$ = function createTouchMove$(originalY) {
        return _Observable.Observable.fromEvent(_this.document, 'touchmove', { passive: false }).map(function (e) {
      ...
      var touchMove$ = _Observable.Observable.fromEvent(this.document, 'touchstart').switchMap(function (e) {
        return createTouchMove$(e.touches[0].clientY);
      });

      var keyDown$ = _Observable.Observable.fromEvent(this.document, 'keydown').filter(function (e) {
      ...
      var focusToggles = document.getElementsByClassName('no-scroll-focus');
      Array.prototype.forEach.call(focusToggles, function (el) {
        el.addEventListener('focus', function () {
          _this.isFreeScrolling = true;
        });
        el.addEventListener('blur', function () {
          _this.isFreeScrolling = false;
        });
      });
      _Observable.Observable.merge(wheel$, keyDown$, touchMove$).subscribe(function (_ref2) {
        var e = _ref2.e,
            direction = _ref2.direction;

        var current = _this.current,
            next = wrapMinMax(current + direction),
            currentOffset = _this.offsets[current],
            nextOffset = _this.offsets[next],
            scrollTop = _this.getScrollTop(),
            heightOffset = _this.offsets[wrapMinMax(current + 1)],
            currentHeight = Math.max(currentOffset, heightOffset) - Math.min(currentOffset, heightOffset);
        if (currentHeight > _this.viewport.h) {
          var distance = scrollTop + _this.viewport.h * direction - nextOffset;
      ...
      var mapNext = function mapNext(source) {
        return function (_ref3) {
          var e = _ref3.e,
              direction = _ref3.direction;

          return { v: wrapMinMax(_this.current + direction), source: source };
        };
      };

      var throttledKeyDown$ = keyDown$.throttleTime(500).map(mapNext('keydown'));

      var throttledTouchMove$ = touchMove$.throttleTime(500).map(mapNext('touchmove'));

      var debouncedScroll$ = _Observable.Observable.fromEvent(this.document, 'scroll').debounceTime(500).map(function (e) {
        return { v: _this.getCurrent(), source: 'scroll' };
      });

      var throttledWheel$ = wheel$.throttleTime(1500).map(mapNext('wheel'));

      this.subscription = _Observable.Observable.merge(throttledWheel$, throttledKeyDown$, debouncedScroll$, throttledTouchMove$).distinctUntilChanged().subscribe(function (_ref4) {
        var v = _ref4.v,
            source = _ref4.source;

        console.log({ source: source, v: v, current: _this.current });
        if (!_this.isFreeScrolling && !_this.isScrolling && v !== _this.current) {
    ...
    value: function init(_ref5) {
      ...
      var viewport = _ref5.viewport;

      this.viewport = viewport;

      var elements = this.document.getElementsByClassName(this.className);
      Array.prototype.forEach.call(elements, function (el) {
        var rect = el.getBoundingClientRect();
        _this2.sections.push(el);
        _this2.offsets.push(_this2.getScrollTop() + rect.top);
      });
    ...
    value: function scrollTo(i) {
      ...
      var options = {
        ...
        complete: function complete() {
          ...
          _this3.complete(last, next);
        }
      };
      (0, _velocityAnimate2.default)(this.getSection(i), 'scroll', options);
    }
  }, {
    key: 'next',
    value: function next() {}
...
var identity_1 = __webpack_require__(63);
/**
...
var throttleTime_1 = __webpack_require__(72);
/**
 * Emits a value from the source Observable, then ignores subsequent source
...
var async_1 = __webpack_require__(9);
var debounceTime_1 = __webpack_require__(74);
/**
...
var Observable_1 = __webpack_require__(0);
var distinctUntilChanged_1 = __webpack_require__(79);
...
var tap_1 = __webpack_require__(83);
/* tslint:enable:max-line-length */
/**
...
var Header = (0, _autobindDecorator2.default)(_class = function () {
  ...
  (0, _createClass3.default)(Header, [{
    ...
    value: function hide() {
      ...
      (0, _velocityAnimate2.default)(this.el, 'fadeOut', {
        duration: 50, complete: function complete() {
    ...
    value: function show() {
      ...
      (0, _velocityAnimate2.default)(this.el, 'fadeIn', {
        duration: 750, complete: function complete() {
...
var _ball = __webpack_require__(91);

var _ball2 = _interopRequireDefault(_ball);

var _paddle = __webpack_require__(92);

var _paddle2 = _interopRequireDefault(_paddle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Pong = (0, _autobindDecorator2.default)(_class = function () {
  function Pong(_ref) {
    var _this = this;
    ...
    var document = _ref.document,
        id = _ref.id,
        scroll = _ref.scroll;
    (0, _classCallCheck3.default)(this, Pong);
    this.mouse = {
      position: { x: 0, y: 0 },
      radius: 100
    };
  ...
  (0, _createClass3.default)(Pong, [{
    ...
    value: function init(_ref2) {
      ...
      this.text = new _text2.default({ viewport: viewport, context: context, document: document });
      var paddle = new _paddle2.default({ viewport: viewport });
      this.ball = new _ball2.default({ viewport: viewport, context: context, paddle: paddle });
    ...
    value: function render() {
      ...
      if (this.scroll.getScrollTop() < 300) {
        ...
        ball.render({ context: context, viewport: viewport, paddle: paddle });
        paddle.render({ context: context, ball: ball, viewport: viewport });
        text.render({ context: context, ball: ball, mouse: mouse, viewport: viewport, paddle: paddle });
      }
...
var Text = (0, _autobindDecorator2.default)(_class = function () {
  function Text(_ref) {
    var viewport = _ref.viewport,
        context = _ref.context,
        document = _ref.document;
    (0, _classCallCheck3.default)(this, Text);
    this.ratio = 533.9 / 218.12;
    this.friction = 0.95;
    this.ease = 0.19;
    this.spacing = 4;
    this.size = 4;
    ...
    for (y = 0; y < viewport.h; y += this.spacing) {
      for (x = 0; x < viewport.w; x += this.spacing) {
        ...
        if (pixels[++index] > 0) {
          this.particles.push(new _particle2.default({ x: x, y: y }));
        }
      }
    }
  ...
  (0, _createClass3.default)(Text, [{
    key: 'updateParticle',
    value: function updateParticle(p, item) {

      var itemX = item.position.x;
      var itemY = item.position.y;
      var itemRadius = Math.pow(item.radius, 2);
      var x = p.position.getX();
      var y = p.position.getY();
      var rx = itemX - x;
      var ry = itemY - y;
      var distance = rx * rx + ry * ry;
      var force = -itemRadius / distance;
    ...
    value: function render(_ref2) {
      ...
      var scrollHeight = this.scrollDown.offsetHeight || this.scrollDown.offsetHeight || 0;
      var top = bottom + (viewport.h - bottom) / 2 - scrollHeight / 2 - paddle.height / 2;
      this.scrollDown.setAttribute("style", "opacity:1;top: " + top + "px");
...
var Ball = (0, _autobindDecorator2.default)(_class = function () {
  function Ball(_ref) {
    var viewport = _ref.viewport,
        paddle = _ref.paddle;
    (0, _classCallCheck3.default)(this, Ball);
    this.logoRatio = 533.9 / 18.185;
    ...
    this.particle = new _particle2.default(options);
...
var Paddle = (0, _autobindDecorator2.default)(_class = function () {
  function Paddle(_ref) {
    var viewport = _ref.viewport;
    (0, _classCallCheck3.default)(this, Paddle);
    this.ratio = 533.9 / 218.12;
    this.logoRatio = 218.12 / 29.01;
  ...
  (0, _createClass3.default)(Paddle, [{
    key: 'render',
    value: function render(_ref2) {
      var context = _ref2.context,
          ball = _ref2.ball,
...
var Menu = (0, _autobindDecorator2.default)(_class = function () {
  function Menu(_ref) {
    var document = _ref.document,
        el = _ref.el,
        scroll = _ref.scroll,
    ...
    this.scroll = scroll;
    var stream$ = _Observable.Observable.empty();

    Array.prototype.forEach.call(toggles, function (el) {
      stream$ = stream$.merge(_Observable.Observable.fromEvent(el, 'click'));
    });
...
var merge_2 = __webpack_require__(8);
